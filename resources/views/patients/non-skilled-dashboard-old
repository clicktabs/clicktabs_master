                                ...
                                <div class="main_content pb-[50px]">
                                    <div id="taab">
                                        <div class="main_content_nav">
                                            <ul class="bg-[#4133BF]">
                                                <li><a href="#taab-Main">Main</a></li>
                                                <li><a href="#taab-ispDoc">ISP Documentation</a></li>
                                                <li><a href="#taab-aar">Annual Agency Reporting</a></li>
                                                <li><a href="#taab-pmuir">Possible MUI Report</a></li>
                                                <li><a href="#taab-uhr">Unanticipated Hospitalization Reporting</a></li>
                                                <li><a href="#taab-ubs">Unapproved Bhavioral Support</a></li>
                                                <li><a href="#taab-uir">Unusual Incident Reporting</a></li>
                                                <li><a href="#taab-timesheet">HPC Time Sheet</a></li>
                                                <li><a href="#taab-upsU">ISP Upload</a></li>
                                            </ul>
                                        </div>

                                        <div class="px-[15px]" id="taab-Main">
                                            @include('patients.components.nonskill.main')
                                        </div>
                                        <div class="px-[15px]" id="taab-ispDoc">
                                            @include('patients.components.nonskill.ISPdocumentation')
                                        </div>

                                        <div class="px-[15px]" id="taab-aar">
                                            @include('patients.components.nonskill.annualAgencyReport')
                                        </div>

                                        <div class="px-[15px]" id="taab-pmuir">
                                            @include('patients.components.nonskill.possibleMuiReportForm')
                                        </div>

                                        <div class="px-[15px]" id="taab-uhr">
                                            @include('patients.components.nonskill.unanticipatedhospitalizationMuiForm')
                                        </div>
                                        <div class="px-[15px]" id="taab-ubs">
                                            @include('patients.components.nonskill.unapprovedBehavioralSupportMuiForm')
                                        </div>
                                        <div class="px-[15px]" id="taab-uir">
                                            @include('patients.components.nonskill.unusualIncidentReportLog')
                                        </div>
                                        <div class="px-[15px]" id="taab-timesheet">
                                            @include('patients.components.nonskill.hpcTimesheet')
                                        </div>
                                        
                                        <div class="px-[15px]" id="taab-upsU">
                                            ISP Upload
                                        </div>
                                    </div>
                                </div>
