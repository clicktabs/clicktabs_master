    ...
    <main>
        <div class="vs jj ttm vl ou uf na">
            ...
            <div class="y pr dw jk rounded-sm la rc !bg-[#4133BF]">
                ...
                <!-- Content -->
                <div class="y">
                    <h1 class="gu teu text-slate-800 font-bold rt !text-[#fff]">{{ $heading }}</h1>
                    <p class="!text-[#fff]">Setup new role</p>
                </div>
            </div>
            {{--            @hasrole('super-admin')--}}
            {{--            <!-- Dashboard actions -->--}}
                            ...
                            <form action="{{ $url }}" method="post" class="row">
                                                    ...
                                                    <select name="SubCategoryId" id=""
                                                        ...
                                                        @foreach ($roles as $role)
                                                            <option value="{{ $role->id }}"
                                                                {{ isset($roleId) && $roleId ==$role->id  ? 'selected' : '' }}>
                                                                {{ $role->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                ...
                                <div class="col-md-2 mt-1">
                                    <input type="submit" value="Save" id="save"
                                           class="btn btn-block hd xu ye float-right">
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('extra_js')
    <script
        src="https://www.jqueryscript.net/demo/Two-side-Multi-Select-Plugin-with-jQuery-multiselect-js/js/multiselect.js"></script>
