<form action="{{ route('pharmacy.store') }}" method="post" class="row">
    @csrf
    <div class="card mb-2">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="address" type="text" class="form-control s ou" name="address" value="{{ old('address') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="telephone">Telephone: <span class="text-red">*</span></label>
                        <input id="telephone" type="text" class="form-control s ou" name="telephone" value="{{ old('telephone') }}">
                    </div>
                </div>
            </div>
            <div class="row">
