    ...
    <main>
        <div class="vs jj ttm vl ou uf na">
            ...
            <div class="y pr dw jk rounded-sm la rc !bg-[#4133BF]">
                ...
                <!-- Content -->
                <div class="y">
                    <h1 class="gu teu text-slate-800 font-bold rt !text-[#fff]">Physicians</h1>
                </div>
            ...
            <div class="je jd jc rc">
                ...
                <div class="sn am jo az jp ft">
                    ...
                    <a type="button" href="{{ route('physician.create') }}" class="btn ho xi ye">
                        ...
                        <span class="hidden trm nq">Add New physician</span>
                    </a>
                    <a type="button" href="{{ route('physician.create') }}" class="btn ho xi ye">
                        <svg class="oo sl du bf ub" viewBox="0 0 16 16">
                            <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z"></path>
                        </svg>
                        <span class="hidden trm nq">Excel Export</span>
                    </a>
            ...
            <div class="row mb-4">
                ...
                <div class="tz tni bg-white bd rounded-sm border border-slate-200 col-md-12">
                    <div class="dk">
                        <!-- Table -->
                        <div class="lf">
                            @include('physicians.components.physician_table')
                        </div>
                    </div>
                </div>
            </div>
...
@section('extra_js')
    ...
    <script>
        $(document).ready(function () {
            let dataTable = $('#physicianTable').DataTable({
                responsive: {
                    details: {
                        type: 'column'
                    }
