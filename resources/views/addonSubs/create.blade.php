    ...
    <div class="y flex ak ug ll lc">
        ...
        <main>
            <div class="vs jj ttm vl ou uf na">
                <div class="rc">
                    <h1 class="gu teu text-slate-800 font-bold">Addon Sub Category Creation ✨</h1>
                </div>
                <div class="bg-white bd rounded-sm rc">
                    <div class="flex ak zc qv">
                                ...
                                <ul class="flex a_ qx ra qm">
                                    <li class="rv qm qg">
                                        <a class="flex items-center vp vr rounded lm hm" href="settings.html">
                                            ...
                                            <span class="text-sm gp text-indigo-500">New Category for {{ $addon->name }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="uw">
                            <form action="{{ route('addonSub.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data" novalidate accept-charset="utf-8">
                                @csrf
                                <div class="d_ fd">
                                    <section>
                                        <h3 class="gf gb text-slate-800 font-bold rt">Add new entry under <span class="addon-name">{{ $addon->name }} </span>Category</h3>
                                        <div class="text-sm">This cuts across all companies that use the platform.</div>
                                        <div class="je jc fg jm jb rw">
                                            <div class="jr">
                                                <label class="block text-sm gp rt" for="name">Name</label>
