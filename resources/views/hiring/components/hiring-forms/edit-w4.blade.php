      ...
      <div class="col-md-12">
        ...
        <table class="table table-bordered align-middle not-responsive default-td" style="border-bottom: 3px solid;">
           <tr>
              ...
              <td>
                 <label for="first_and_middle_name" class="form-label fw-medium mb-1">(a) First name and middle initial</label>
                 <input type="text" name="first_and_middle_name" id="first_and_middle_name" class="form-control" value="{{ old('first_and_middle_name') }}" >
              </td>
              <td>
                 <label for="last_name" class="form-label fw-medium mb-1">Last name</label>
                 <input type="text" name="last_name" id="last_name" value="{{ old('last_name') }}" class="form-control">
              </td>
              <td>
                 <label for="social_security_number" class="form-label fw-medium mb-1">(b) Social security number</label>
                 <input type="text" name="social_security_number" id="social_security_number" value="{{ old('social_security_number') }}" class="form-control">
              </td>
           </tr>
           <tr>
              <td colspan="2">
                 <label for="w4_address" class="form-label fw-medium mb-1">Address</label>
                 <input type="text" name="w4_address" id="w4_address" value="{{ old('w4_address') }}" class="form-control">
              </td>
           ...
           <tr>
              <td colspan="2">
                 ...
                 <input type="text" name="w4_city_town_state_zip" id="w4_city_town_state_zip" value="{{ old('w4_city_town_state_zip') }}" class="form-control">
              </td>
           </tr>
           <tr>
              <td colspan="3">
                 <div class="d-flex">
                    ...
                    <div>
                       <div class="d-block">
                          <label class="form-check-label" for="w4_single_or_married"><input type="checkbox" name="w4_single_or_married" id="w4_single_or_married" value="{{ old('w4_single_or_married') }}" class="form-check-input"> <b>Single or Married filing separately</b></label>
                       </div>
                       <div class="d-block">
                          <label class="form-check-label" for="w4_married_filing" ><input type="checkbox" name="w4_married_filing" id="w4_married_filing" value="{{ old('w4_married_filing') }}" class="form-check-input"> <b>Married filing jointly or Qualifying surviving spouse</b></label>
                       </div>
                       <div class="d-block">
                          <label class="form-check-label" for="w4_head_of_household"><input type="checkbox" name="w4_head_of_household"  id="w4_head_of_household" value="{{ old('w4_head_of_household') }}" class="form-check-input"> <b>Head of household</b> (Check only if you’re unmarried and pay more than half the costs of keeping up a home for yourself and a qualifying individual.)</label>
                       </div>
                    </div>
                 </div>
              </td>
        ...
        <table class="table table-bordered align-middle not-responsive default-td mb-0" style="border-bottom: 3px solid;">
           <tr>
              ...
              <td>
                 ...
                 <label class="input-group clean-input-group d-inline-flex w-auto" for="married_filing_jointly" >
                    <span class="input-group-text"><b>$</b></span>
                    <input type="text"  name="married_filing_jointly" id="married_filing_jointly" value="{{ old('married_filing_jointly') }}" class="form-control">
                 </label>
                 <br>
                 Multiply the number of other dependents by $500 . . .
                 <label class="input-group clean-input-group d-inline-flex w-auto" for="claim_dependents">
                    <span class="input-group-text"><b>$</b></span>
                    <input type="text" name="claim_dependents" id="claim_dependents" value="{{ old('claim_dependents') }}" class="form-control">
                 </label>
              ...
              <td class="align-bottom">
                 <label class="input-group clean-input-group" for="other_credits">
                    <span class="input-group-text"><b>$</b></span>
                    <input type="text" name="other_credits" id="other_credits" value="{{ old('other_credits') }}" class="form-control">
                 </label>
              </td>
           </tr>
           <tr>
              ...
              <td>
                 <label class="input-group clean-input-group" for="other_income">
                    <span class="input-group-text"><b>$</b></span>
                    <input type="text" name="other_income" id="other_income" value="{{ old('other_income') }}" class="form-control">
                 </label>
              </td>
           </tr>
           <tr>
              ...
              <td>
                 <label class="input-group clean-input-group" for="claim_deductions">
                    <span class="input-group-text"><b>$</b></span>
                    <input type="text" name="claim_deductions" id="claim_deductions" value="{{ old('claim_deductions') }}" class="form-control">
                 </label>
              </td>
           </tr>
           <tr>
              ...
              <td>
                 <label class="input-group clean-input-group" for="additional_tax_withheld">
                    <span class="input-group-text"><b>$</b></span>
                    <input type="text" name="additional_tax_withheld" id="additional_tax_withheld" value="{{ old('additional_tax_withheld') }}" class="form-control">
                 </label>
              </td>
           </tr>
        </table>
        ...
        <table class="table table-bordered align-middle not-responsive default-td mb-0" style="border-bottom: 3px solid;">
           ...
           <tr>
              <td class="clean-input-group" for="employee_signature">
                 <input type="text"name="employee_signature" id="employee_signature"  value="{{ old('employee_signature') }}" class="form-control">
                 <b>Employee’s signature</b> (This form is not valid unless you sign it.)
              </td>
              <td class="clean-input-group" for="signature_date">
                 <input type="text"  name="signature_date" id="signature_date" value="{{ old('signature_date') }}" class="form-control">
                 <b>Date</b>
              </td>
           </tr>
        </table>
        ...
        <table class="table table-bordered align-middle not-responsive default-td mb-0" style="border-bottom: 3px solid;">
           <tr>
              ...
              <td>
                 <label for="w4_employee_name_address" class="form-label">Employer’s name and address</label>
                 <textarea  cols="30" rows="2" class="form-control" name="w4_employee_name_address" id="w4_employee_name_address" value="{{ old('w4_employee_name_address') }}"></textarea>
              </td>
              <td>
                 <label for="w4_employee_dirst_date" class="form-label">First date of employment</label>
                 <input type="date" name="w4_employee_dirst_date" id="w4_employee_dirst_date" value="{{ old('w4_employee_dirst_date') }}" class="form-control">
              </td>
              <td>
                 <label for="w4_employee_id_number" class="form-label">Employer identification number (EIN)</label>
                 <input type="text" name="w4_employee_id_number" id="w4_employee_id_number" value="{{ old('w4_employee_id_number') }}" class="form-control">
              </td>
           </tr>
        </table>
           ...
           <table class="table table-borderless align-middle not-responsive mb-0">
                ...
                <tr>
                   ...
                   <td class="align-bottom" style="min-width: 220px;">
                      <label class="input-group clean-input-group" for="two_jobs_married_filling_jointly">
                         <span class="input-group-text"><b>1 $</b></span>
                         <input type="text" name="two_jobs_married_filling_jointly" id="two_jobs_married_filling_jointly" value="{{ old('two_jobs_married_filling_jointly') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   ...
                   <td class="align-bottom">
                      <label class="input-group clean-input-group" for="spouse_has_three_jobs">
                         <span class="input-group-text"><b>2a $</b></span>
                         <input type="text" name="spouse_has_three_jobs" id="spouse_has_three_jobs" value="{{ old('spouse_has_three_jobs') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   ...
                   <td class="align-bottom">
                      <label class="input-group clean-input-group" for="annual_wages_highest">
                         <span class="input-group-text"><b>2b $</b></span>
                         <input type="text"name="annual_wages_highest" id="aannual_wages_highest" value="{{ old('annual_wages_highest') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   ...
                   <td class="align-bottom">
                      <label class="input-group clean-input-group" for="add_the_amount_2a_2b">
                         <span class="input-group-text"><b>2c $</b></span>
                         <input type="text" name="add_the_amount_2a_2b" id="add_the_amount_2a_2b" value="{{ old('add_the_amount_2a_2b') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   ...
                   <td class="align-bottom">
                      <label class="input-group clean-input-group" for="enter_pay_periods">
                         <span class="input-group-text"><b>3 $</b></span>
                         <input type="text" name="enter_pay_periods" id="enter_pay_periods" value="{{ old('enter_pay_periods') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   <td><b>4 Divide</b> the annual amount on line 1 or line 2c by the number of pay periods on line 3. Enter this amount here and in <b>Step 4(c)</b> of Form W-4 for the highest paying job (along with any other additionalamount you want withheld)</td>
                   <td class="align-bottom">
                      <label class="input-group clean-input-group" for="line_1_or_line_2c">
                         <span class="input-group-text"><b>3 $</b></span>
                         <input type="text" name="line_1_or_line_2c" id="line_1_or_line_2c" value="{{ old('line_1_or_line_2c') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                ...
                <tr>
                   ...
                   <td class="align-bottom" style="min-width: 220px;" for="itemized_deductions">
                      <label class="input-group clean-input-group">
                         <span class="input-group-text"><b>1 $</b></span>
                         <input type="text" name="temized_deductions" id="temized_deductions" value="{{ old('temized_deductions') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   ...
                   <td class="align-bottom" style="min-width: 220px;" for="qualifying_surviving">
                      <label class="input-group clean-input-group">
                         <span class="input-group-text"><b>2 $</b></span>
                         <input type="text" name="qualifying_surviving" id="qualifying_surviving" value="{{ old('qualifying_surviving') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   ...
                   <td class="align-bottom" style="min-width: 220px;">
                      <label class="input-group clean-input-group" for="suntract_line_2">
                         <span class="input-group-text"><b>3 $</b></span>
                         <input type="text" name="suntract_line_2" id="suntract_line_2" value="{{ old('suntract_line_2') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   ...
                   <td class="align-bottom" style="min-width: 220px;">
                      <label class="input-group clean-input-group" for="student_loan">
                         <span class="input-group-text"><b>4 $</b></span>
                         <input type="text" name="student_loan" id="student_loan" value="{{ old('student_loan') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
                <tr>
                   <td><b>5 Add</b> lines 3 and 4. Enter the result here and in <b>Step 4(b)</b> of Form W-4</td>
                   <td class="align-bottom" style="min-width: 220px;" for="enter_line_3">
                      <label class="input-group clean-input-group">
                         <span class="input-group-text"><b>5 $</b></span>
                         <input type="text" name="enter_line_3" id="enter_line_3" value="{{ old('enter_line_3') }}" class="form-control" style="min-width: 150px;">
                      </label>
                   </td>
                </tr>
             </table>
