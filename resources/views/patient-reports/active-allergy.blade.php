        ...
        <div class="vs jj ttm vl ou uf na">
            <div class="row mb-4">
                ...
                <div class="tz tni bg-white bd rounded-sm border border-slate-200 col-md-12">
                    <div class="dk">
                        <h1 class=" mb-4 ext-center fw-bolder">Active Allergies Report</h1>
                        ...
                        <div class="colo-md-12">
                            <table class="ux ou" id="oasis-export">
                                ...
                                <tr>
                                    ...
                                    <th class="dx">
                                        <div class="gh gt">Allergies</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Type</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Severity</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Start Date</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">End Date</div>
                                    </th>
                                     <th class="dx">
                                ...
                                <tr>
                                    <td></td>
                                    <td class="">
                                        <div class="gn">{{$allergy->patient_id}}</div>
                                    </td>
                                    <td class="">
