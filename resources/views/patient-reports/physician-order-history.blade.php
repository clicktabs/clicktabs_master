        ...
        <div class="vs jj ttm vl ou uf na">
            <div class="row mb-4">
                ...
                <div class="tz tni bg-white bd rounded-sm border border-slate-200 col-md-12">
                    <div class="dk">
                        <h1 class=" mb-4 ext-center fw-bolder">All Open OASIS Assessment</h1>
                        ...
                        <div class="colo-md-12">
                            <table class="" id="oasis-export">
                                <thead class="go rounded-sm bg-[#4133BF] text-[#fff]">
                                <tr>
                                    <th></th>
                                    <th class="dx">
                                        <div class="dx">Patient Name</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">MR #</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">OASIS</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Scheduled</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Status</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Currently Assigned</div>
                                    </th>
                                </tr>
                                </thead>
                                <!-- Table body -->
                                ...
                                <tr>
                                   ...
                                   <td class="">
                                    ...
                                    <td class="dx flex flex-wrap gap-[10px]">
                                        <a href="#" class="btn ho xi ye edit">Edit</a>
