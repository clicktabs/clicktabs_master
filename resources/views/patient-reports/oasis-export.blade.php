        ...
        <div class="vs jj ttm vl ou uf na">
            <div class="row mb-4">
                ...
                <div class="tz tni bg-white bd rounded-sm border border-slate-200 col-md-12">
                    <div class="dk">
                        <h1 class=" mb-4 ext-center fw-bolder">List of Exported OASIS Assessment</h1>
                        ...
                        <div class="colo-md-12">
                            <table class="ux ou" id="oasis-export">
                                ...
                                <tr>
                                    ...
                                    <th class="dx">
                                        <div class="gh gt">Assessment Date</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Episode Date</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Insurance</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Correction</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Cancel</div>
                                    </th>
                                    <th class="dx">
