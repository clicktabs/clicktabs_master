        ...
        <div class="vs jj ttm vl ou uf na">
            <div class="row mb-4">
                ...
                <div class="tz tni bg-white bd rounded-sm border border-slate-200 col-md-12">
                    <div class="dk">
                        <h1 class=" mb-4 ext-center fw-bolder">Pending Face to Face Encounters Report</h1>
                        ...
                        <div class="colo-md-12">
                            <table class="ux ou" id="oasis-export">
                                ...
                                <tr>
                                    ...
                                    <th class="dx">
                                        <div class="gh gt">MR Number</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Medicare Number</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Physician</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">SOC</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">485 Status</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Days Untill Required</div>
                                    </th>
                                </tr>
                                </thead>
                                <!-- Table body -->
