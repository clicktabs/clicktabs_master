        ...
        <div class="vs jj ttm vl ou uf na">
            <div class="row mb-4">
                ...
                <div class="tz tni bg-white bd rounded-sm border border-slate-200 col-md-12">
                    <div class="dk">
                        <h1 class=" mb-4 ext-center fw-bolder">Orders History</h1>
                        ...
                        <div class="colo-md-12">
                            <table class="ux ou" id="oasis-export">
                                ...
                                <tr>
                                    ...
                                    <th class="dx">
                                        <div class="gh gt">Order Type</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Physician</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Sent By</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Oder Date</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">MD Sign Date </div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Sent Date</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Received Date</div>
                                    </th>
                                    <th class="dx">
