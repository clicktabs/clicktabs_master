                        ...
                        <div class="colo-md-12">
                            <table class="ux ou" id="oasis-export">
                                ...
                                <tr>
                                    ...
                                    <th class="dx">
                                        <div class="gh gt">Temperature</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Pulse</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Respiration</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Blood Pressure</div>
                                    </th>
                                    <th class="dx">
                                        <div class="gh gt">Pulse Oximetry</div>
                                    </th>
                                    <th class="dx">
                                ...
                                <tr>
                                   ...
                                   <td class="dx">
                                        <div class="gn">Kangaroo, Captain</div>
                                    </td>
                                    <td class="dx">
                                        <div class="gn">No</div>
                                    </td>
