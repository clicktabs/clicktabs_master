...
@section('content')
                    ...
                    <div class="card border-0 shadow-sm my-3 overflow-hidden">
                        <div class="p-3 p-sm-3 p-md-4 p-lg-5">
                            <div class="text-center mt-3 mb-5">
                                <h1 class="fw-bolder display-4 text-primary">{{ Auth::user()->organization->name }}</h1>
                            </div>

                            <div class="col-sm-12 my-auto mb-4 text-center">
                                <p class="text-dark mt-4 mb-0 lead">
                                    <span id="current-day" class="text-capitalize"></span>, <spam id="current-date"
                                        class="text-capitalize"></spam>
                                </p>
                            ...
                            <form action="" method="get" autocomplete="off" class="col-md-8 m-auto">
                                <div class="mb-3 text-center">
                                    ...
                                    <input type="text" name="idno" class="form-control text-uppercase" placeholder=""
                                        autofocus required>
                                </div>
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        <div class="d-grid mb-3">
                                            <button id="btn-clockin" type="button" data-method="clockin"
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-grid mb-3">
                                            <button id="btn-clockout" type="button" data-method="clockout"
    ...
    <div class="position-fixed p-3 d-flex justify-content-center align-items-cente"
        style="z-index: 9; left: 0; right: 0; bottom: 0;">
...
@section('scripts')
    <script type="text/javascript">
        var url = '{{ url('/') }}';
        var timezone =
            '@isset($timezone){{ $timezone }}@endisset';
        var timeformat =
            '@isset($timeformat){{ $timeformat }}@endisset';
