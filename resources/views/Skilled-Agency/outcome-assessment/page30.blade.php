         ...
         <h1 class="text-center heading_1">HOME HEALTH CERTIFICATION AND PLAN OF CARE</h1>
            ...
            <tr>
               <td>
                  ...
                  <input type="number" name="hiClaimNo" id="hiClaimNo" class="form-control" value="{{$patient->cms->hiClaimNo}}">
               </td>
               <td>
         ...
         <table class="table table-bordered mb-0">
            ...
            <tr>
               <td>
                  ...
                  <textarea name="substance" id="substance" cols="30" rows="1" class="form-control">{{$patient->cms->substance}}</textarea>
               </td>
               <td>
                  <label for="reaction">Reaction</label>
                  <textarea name="reaction" id="reaction" cols="30" rows="2" class="form-control">{{$patient->cms->reaction}}</textarea>
               </td>
            </tr>
            <tr>
               <td colspan="2">
