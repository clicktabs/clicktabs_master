{{-- <table class="table table-bordered align-middle">
                     ...
                     <tr>
                        <td class="bg-secondary-subtle" colspan="2">
                           ...
                           <p>Code the patient’s usual performance at Discharge for each activity using the 6-point scale. If activity was not attempted at Discharge, code the reason.</p>
                        </td>
                     </tr>
                     <tr>
                        <td colspan="2">
                           <h5>Coding:</h5>
                           <p>Safety and Quality of Performance – If helper assistance is required because patient’s performance is unsafe or of poor quality, score according to amount of assistance provided.</p>
                     ...
                     <tr>
                        <td class="p-0 border-0 overflow-hidden">
                           <table class="table table-bordered align-middle nmt-1 nmb-1">
                              <tr>
                                 <td class="bg-secondary-subtle text-center" style="max-width: 120px;"><b>4.<br>Follow-Up<br>Performance</b></td>
                                 <td></td>
                              </tr>
                              <tr>
                                 <td class="text-center" style="max-width: 120px;"><b>Enter Codes<br>in Boxes<br>↓</b></td>
                                 <td></td>
                              </tr>
                              <tr>
                                 <td><input type="number" name="dischargeEating" class="form-control"></td>
                              ...
                              <tr>
                                 <td><input type="number" name="dischargeOralHygiene" class="form-control"></td>
                                 <td><label for="">B. <b>Oral Hygiene</b>: The ability to use suitable items to clean
                                    ...
                                    from mouth, and manage denture soaking and rinsing with use ofequipment.</label></td>
                              </tr>
                              <tr>
                                 <td><input type="number" name="dischargeToileting" class="form-control"></td>
                              ...
                              <tr>
                                 <td><input type="number" name="dischargebatheself" class="form-control"></td>
                              ...
                              <tr>
                                 <td><input type="number" name="dischargeUpperbodyDressing" class="form-control"></td>
                              ...
                              <tr>
                                 <td><input type="number" name="dischargeLowerbodyDressing" class="form-control"></td>
                                 <td><label for=""><label for="">G. <b>Lower body dressing</b>: The ability to dress and undress below
                                    the waist, including fasteners; doesnotinclude footwear.</label></td>
                              </tr>
                              <tr>
                                 <td><input type="number" name="dischargeFootware" class="form-control"></td>
