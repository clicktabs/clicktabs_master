...
<div class="container">
            <div class="d-flex flex-column" style="background: white;">
                ...
                <div class="d-flex flex-column mt-2 border mx-3 mb-4">
                    ...
                    <div class="d-flex border flex-row">
                        <div class="col-md-2 border px-2 py-2">
                            ...
                            <input type="text" name="HIClaimNo" placeholder="Patient's HI Claim No." class="form-control">
                        </div>
                        <div class="col-md-2 border px-2 py-2">2. Start Of Care Date
                            <input type="date"  name="startCareDate" class="form-control" value="{{$petiming->start_care_date}}" >
                        </div>
                        <div class="col-md-4 d-flex flex-column border">
                            ...
                            <div class="d-flex flex-row justify-content-around">
                                <div class="" style="margin-right: 10px;">From
                                    <input type="text" name="CertificationPeriodFrom1" placeholder="From" class="form-control   mr-1">
                                </div>
                                <div>To
                                    <input type="text" name="CertificationPeriodTo1"  placeholder="To" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2 border px-2 py-2">4. Medical Record No
                            <input type="text" placeholder="Medical Record No" name="medicalRecrodNo1" class="form-control">
                        </div>
                        <div class="col-md-2 px-2 py-2">5. Provider No.
                            <input type="text" placeholder="Provider No." name="ProviderNo1" class="form-control">
                        </div>
                    ...
                    <div class="d-flex flex-row border">
                        <div class="d-flex col-md-6 border-end px-2 py-2">
                            <div class="from-group col-md-12 py-2">
                                ...
                                <input type="text" placeholder="Patient's Name and Address" class="form-control" name="PatientsNameandAddress1"  value="{{$patient->first_name}} {{$patient->last_name}} | {{$addressInfo->address_line_1}} {{$addressInfo->address_line_2}}">
                            </div>
                        </div>
                        <div class="d-flex col-md-6 px-2 py-2">
                            <div class="from-group col-md-12 py-2">
                                7. Provider's Name, Address and Telephone Number
                                <input type="text" class="form-control" placeholder="Provider's Name, Address and Telephone Number" name="providerinfo1" value="{{$addressserviceInfo->address_line_1}} {{$addressserviceInfo->address_line_2}} | {{$addressserviceInfo->phone}}">
                            </div>
                        </div>
                    </div>
                    <div class="d-flex flex-row border">
                        <div class="d-flex flex-column col-md-6">
                            <div class="d-flex flex-row ">
                                <div class="col-md-7 border-end px-2 py-2">8. Date of Birth
                                    <input type="date" class="form-control" name="dateofbirth" value="{{$patient->date_of_birth}}">
                                </div>
                                <div class="col-md-5 px-2 py-2">
                                    9. Sex
                                    <input type="radio" name="sex" id="Male" value="1" <?php echo ($patient->gender == 'male') ? 'checked' : ''; ?>>
                                    <label for="Male">M</label>
                                    <input type="radio" name="sex" id="Female" value="2" <?php echo ($patient->gender == 'female') ? 'checked' : ''; ?>>
                        ...
                        <div class="d-flex col-md-6 border-start px-2 py-2">
                            <div class="from-group col-md-12 py-2">
                                ...
                                <textarea class="form-control py-2" rows="12" placeholder="Medications: Dose/Frequency/Route (N)ew (C)hanged (U)nchanged"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex flex-row">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-md-6 border d-flex px-2 py-2">
                            <div class="from-group col-md-12 py-2">
                                17. Allergies: <input type="text" placeholder="" class="form-control" name="Allergies">
                            </div>
                        </div>
                    </div>
                    <div class="d-flex flex-row">
                    ...
                    <div class="d-flex border px-2 py-2" style="height: 300px;">
                        <div class="from-group col-md-12 py-2">
                            ...
                            <textarea class="form-control py-2" rows="7"></textarea>
                    ...
                    <div class="d-flex flex-row border" >
                        <div class="d-flex col-md-8 border-end px-2 py-2">
                            <div class="from-group col-md-12 py-2">
                                23. Nurse's Signature and Date of Verbal SOC Where Applicable: <input type="date" class="form-control" name="NursesSignature">
                            </div>
                        </div>
                ...
                <div class="d-flex flex-column border mt-2 mx-3 mb-4">
                    ...
                    <div class="d-flex border flex-row">
                        <div class="col-md-2 border-end px-2 py-2">1. Patient's HI Claim No. <input type="text" placeholder="" class="form-control" name="HIClaimNo2">
                        </div>
                        <div class="col-md-2 border-end px-2 py-2">2. Start Of Care Date <input type="date"  class="form-control" name="StartOfCareDate2" value="{{$petiming->start_care_date}}">
                        </div>
                        <div class="col-md-4 d-flex flex-column border-end">
                            <div class="px-2 py-2">3. Certification Period</div>
                            <div class="d-flex flex-row justify-content-around">
                                <div>From <input type="date" class="form-control" name="CertificationPeriodFrom">
                                </div>
                                <div>To <input type="date" class="form-control" name="CertificationPeriodTo">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2 border-end px-2 py-2">4. Medical Record No
                            <input type="text" placeholder="" class="form-control" name="MedicalRecordNo">
                        </div>
                        <div class="col-md-2  px-2 py-2">5. Provider No. <input type="text" placeholder="" class="form-control" name="ProviderNo2">
                        </div>
                    ...
                    <div class="d-flex flex-row border">
                        ...
                        <div class="d-flex col-md-6 px-2 py-2">
                            <div class="from-group col-md-12 py-2">
                                ...
                                7. Provider's Name
                                <input type="text" placeholder="" class="form-control" name="providersName2">
                            </div>
                    ...
                    <div class="d-flex px-2 py-2">
                        <div class="from-group col-md-12 py-2">
                            8. of care and will periodically review the plan

                            <input type="text" placeholder="of care and will periodically review the plan" class="form-control" name="periodicallyreviewtheplan">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-row border">
                        <div class="d-flex col-md-8 border-end px-2 py-2">
                            <div class="from-group col-md-12">
                                ...
                                <input type="text" placeholder="Signature of Physician" class="form-control" name="signatureofPhysician">
                            </div>
                        </div>
                        <div class="d-flex col-md-4 px-2 py-2">
                            ...
                            <div class="from-group">
                                ...
                                <input type="date" id="physicalsign" class="form-control" >
                    ...
                    <div class="d-flex flex-row border">
                        <div class="d-flex col-md-8 border-end px-2 py-2">
                            <div class="from-group col-md-12 py-2">
                                ...
                                <input type="text" id="optionsing" class="form-control" >
                            </div>
                        </div>
                        <div class="d-flex col-md-4 px-2 py-2">
                            <div class="from-group">
