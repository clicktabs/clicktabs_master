...
<main>
   ...
   <div class="container">
      ...
      <div class="form-holder pt15 pb-5">
         <form action="store" name="hhavisitnote" id="hhavisitnote" method="POST">
            @csrf
                  ...
                  <tr>
                        ...
                        <table class="table table-bordered align-middle default-td">
                           ...
                           <tr>
                              <td class="labels-group">
                                 ...
                                 <label class="form-check-label" for="bed_bath_1"><input type="radio" name="bed_bath" id="bed_bath_1" value="1" class="form-check-input"> Partial</label>
                                 <label class="form-check-label" for="bed_bath_2"><input type="radio" name="bed_bath" id="bed_bath_2" value="1" class="form-check-input"> Complete</label>
                              </td>
                           ...
                           <tr>
                              <td class="labels-group">
                                 <label class="form-check-label" for="assis_bath_chair"><input type="radio" name="assis_bath_chair_1" id="assis_bath_chair" value="1" class="form-check-input_1">
                     ...
                     <td class="p-0">
                        <table class="table table-bordered align-middle default-td">
                           ...
                           <tr>
                              <td class="labels-group">
                                 <label class="form-check-label" for="limit"><input type="radio" name="radio_1" id="limit" value="1" class="form-check-input"> Limit</label>
                                 <label class="form-check-label" for="encourage_fluides"><input type="radio" name="radio_1" id="encourage_fluides" value="1" class="form-check-input"> Encourage Fluides</label>
                              </td>
