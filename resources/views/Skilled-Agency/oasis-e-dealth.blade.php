...
@section('content')
    ...
    <div class="form-holder">
        <form action="{{route('skilled-agency.oasis-e-death.store')}}" method="post" id="oasis-e-form" method="POST">
            @csrf
        <!-- SectionA -->
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="ps-3 mb-1">
                            ...
                            <div class="d-block"><label class="form-check-label"><input type="checkbox" name="inpatientFacility_1" value="1" class="form-check-input"> 7. <b>Transferred to an inpatient facility –</b> patient discharged from agency</label></div>
                        </div>

                        <p class="mb-1"><b>Discharge from Agency – Not to an Inpatient Facility</b></p>
                        <div class="ps-3">
                            <div class="d-block"><label class="form-check-label"><input type="checkbox" name="Discharge" class="form-check-input" value="1"> 8. <b>Death at home</b></label></div>
                        </div>
                    </td>
                    </tr>
                    <tr><td class="border-0"></td></tr>
            ...
            <table class="table table-bordered align-middle not-responsive default-td">
                    ...
                    <td>
                        ...
                        <div class="mt-2">
                            ...
                            <div class="input-group d-inline-flex ms-2" style="width: auto;">
                                ...
                                <input type="text" id="" name="reference_reason" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="mt-2">
                            <label for="" class="form-check-label"><input type="checkbox" class="form-check-input" value="1" name="HHAdisciplines"> HHA disciplines involved:</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="SNdisciplines"> SN</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="PTdisciplines"> PT</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="OTdisciplines"> OT</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="STdisciplines"> ST</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="MSWdisciplines"> MSW</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="Aidedisciplines"> Aide</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="Otherdisciplines"> Other:</label>
                            <div class="input-group d-inline-flex ms-1" style="width: auto;">
                                <input type="text" id="" class="form-control" name="OtherHHAdisciplines">
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <div>
                            ...
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="SNtransfer" value="notifiedSN"> SN</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="PTtransfer" value="notifiedPT"> PT</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="OTtransfer"value="notifiedOT"> OT</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="STtransfer"value="notifiedST"> ST</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="MSWtransfer"value="notifiedMSW"> MSW</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="Aidetransfer" value="notifiedAide"> Aide</label>
                            <label for="" class="form-check-label ms-2"><input type="checkbox" class="form-check-input" value="1" name="Othertransfer" value="notifiedOther"> Other:</label>
                            <div class="clean-input-group border d-inline-flex ms-1" style="width: auto;">
                                <input type="text" id="" class="form-control" name="OtherTeamMembers">
                            </div>
                        </div>

                        <div class="mt-1 ms-3">
                            <label class="form-check-label"><input type="checkbox" class="form-check-input" name="agencyPolicy"> Appropriate physician(s) per agency policy</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="RepresentativePP"> Representative (if any) per agency policy/procedure</label>
                        ...
                        <div class="mt-2">
                            <label class="form-check-label"><input type="checkbox" class="form-check-input" name="documentation" value=""> Additional documentation provided per agency policy/process, and/or requested by receiving provider.</label>
                            <div class="ms-3">
                                <label class="form-check-label d-block"><input type="checkbox" class="form-check-input" name="currentPlan" value=""> Copy of current plan of care</label>
                                <div>
                                ...
                                <label class="form-check-label d-block"><input type="checkbox" class="form-check-input" name="copyOrder"> Copy of transfer order</label>

                                <label for="" class="form-check-label"><input type="checkbox" class="form-check-input" name="copyOther_1"> Other:</label>
                                <div class="clean-input-group border d-inline-flex ms-1" style="width: auto;">
                ...
                <tr>
                    <td>
                        <div>
                            <span>All involved team members notified of transfer:</span>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="involvedSN" value="1"> SN</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="involvedPT" value="1"> PT</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="involvedOT" value="1"> OT</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="involvedST" value="1"> ST</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="involvedMSW" value="1"> MSW</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="involvedAide" value="1"> Aide</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="teamMembers" value="1"> All involved team members</label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="otherMembers" value="1"> Other:</label>
                            <div class="clean-input-group border d-inline-flex ms-1" style="width: auto;">
                ...
                <tr>
                    <td>
                        <div>
                            <b>Copy of summary:</b>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="malled" value="1"> <b>malled</b></label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="emalled" value="1"> <b>emalled</b></label>
                            <label class="form-check-label ms-2"><input type="checkbox" class="form-check-input" name="faxed" value="1"> <b>faxed</b></label>
                            <label class="form-check-label ms-2" style="font-weight: 400;"><input type="checkbox" class="form-check-input" name="faxed_1" value="facility"> Facility Name</label>
                            <div class="clean-input-group border d-inline-flex ms-1" style="width: auto;">
                                <input type="text" name="facilityName_1" id="" class="form-control">
                            </div>
                        </div>
                                ...
                                <td>
                                    <table class="table table-borderless">
                                        <tr>
                                            <td class="pb-1">
                                                <div class="d-flex">
                                                    <label class="form-check-label ms-2" style="font-weight: 400;"><input type="checkbox" class="form-check-input" name="certifyingPhysician_1" value="certifying"> Certifying Physician:</label>
                                        ...
                                        <tr>
                                            <td class="pb-1 pt-1">
                                                <div class="d-flex">
                                                    <label class="form-check-label ms-2" style="font-weight: 400;"><input type="checkbox" class="form-check-input" name="primaryCareProvider"> Primary Care Provider Post-transfer/DAH:</label>
                                                    <div class="clean-input-group border flex-grow-1 ms-1">
                                        ...
                                        <tr>
                                            <td class="pt-1">
                                                <div class="d-flex">
                                                    <label class="form-check-label ms-2" style="font-weight: 400;"><input type="checkbox" class="form-check-input" name=""> Representative (if any):</label>
                                                    <div class="clean-input-group border flex-grow-1 ms-1">
