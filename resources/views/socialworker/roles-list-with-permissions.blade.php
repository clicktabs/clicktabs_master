        ...
        <div class="vs jj ttm vl ou uf na">
            ...
            <div class="y pr dw jk rounded-sm la rc !bg-[#4133BF]">
                ...
                <div class="y">
                    ...
                    <p class="!text-[#fff]">Setup roles with permissions for users</p>
                </div>
            ...
            <div class="je jd jc rc">
                ...
                <div class="sn am jo az jp ft">
                    ...
                    <!-- Add view button -->
                    <a type="button" href="{{ route('create-role-with-permissions') }}" class="btn ho xi ye">
            ...
            <tr>
                <td class="dx">
                    <div class="flex items-center">
                        <div class="text-slate-800 font-weight-bolder" style="font-weight: 700;">@foreach($subCategoryRoles as $subCategoryRole) @if($subCategoryRole->id==$roleId) {{$subCategoryRole->name}} @endif @endforeach</div>
                    </div>
                </td>
                <td class="dx">
                    <a href="{{ route('edit-role-with-permissions', ['addon_subcategory_id' => $roleId]) }}" class="btn ho xi ye">Edit</a>
                </td>
                {{-- <td class="dx">
