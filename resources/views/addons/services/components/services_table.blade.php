    ...
    <tbody class="text-sm gp le ln">
        ...
        @if ($addonServices)
            ...
            <tr>
                ...
                <td class="dx">
                    <div class="gn">{{ $addonService->services_desc }}</div>
                </td>
                <td class="dx">
                    <div class="gn">
                ...
                <td class="dx">
                    <a href="{{ route('service.edit', encrypt($addonService->id)) }}" class="btn ho xi ye">Edit</a>
                </td>
                <td class="dx">
                    <form action="{{ route('change_services_status') }}" method="post">
                        @csrf
