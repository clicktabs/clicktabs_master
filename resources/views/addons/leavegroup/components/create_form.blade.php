<form action="{{ route('leaveGroups.store') }}" method="post" class="row">
    @csrf
    <div class="card mb-2">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="description" type="text" class="form-control s ou" name="description" value="{{ old('description') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="leave_privileges">Leave Privileges: </label>
                        <input id="leave_privileges" type="text" class="form-control s ou" name="leave_privileges" value="{{ old('leave_privileges') }}">
                    </div>
                </div>
            </div>
            @hasrole('super-admin')
