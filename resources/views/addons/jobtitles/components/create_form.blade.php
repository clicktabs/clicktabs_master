<form action="{{ route('jobTitles.store') }}" method="post" class="row">
    @csrf
    <div class="card mb-2">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="job_title" type="text" class="form-control s ou" name="job_title" value="{{ old('name') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="job_title_short">Job Title (Short): </label>
                        <input id="job_title_short" type="text" class="form-control s ou" name="job_title_short" value="{{ old('reference_code') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
