<form action="{{ route('races.store') }}" method="post" class="row">
    @csrf

    <div class="card mb-2">
        <div class="card-header text-center">
            <h2 class="gh text-slate-800">New Information</h2>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="race_type" type="text" class="form-control s ou" name="race_type" value="{{ old('race_type') }}"">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
