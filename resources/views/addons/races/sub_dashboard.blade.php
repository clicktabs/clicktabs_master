    ...
    <main>
        <div class="vs jj ttm vl ou uf na">
            ...
            <div class="y pr dw jk rounded-sm la rc">
                ...
                <!-- Content -->
                <div class="y">
                    <h1 class="gu teu text-slate-800 font-bold rt">Race Addon:: Editing for <b class="underline">{{ $name }}</b></h1>
                ...
                <div class="sn am jo az jp ft">
                    ...
                    @hasrole('super-admin')
                        @if (Auth::user()->organization_id == null)
                            ...
                            <a href="/races" class="btn bg-white border-slate-200 hover--border-slate-300 text-slate-500 hover--text-slate-600" aria-haspopup="true">
            ...
            <div class="row mb-4">
                ...
                <div class="tz tni bg-white bd rounded-sm border border-slate-200 col-md-12">
                    <header class="vc vu cs ch">
                        <h2 class="gh text-slate-800">Race Addon:: <b class="underline">{{ $name }}</b></h2>
                    </header>
                    <div class="dk">
