...
use App\Http\Controllers\InfectionControllerController;
...
// Route::post('/hiring/storememo',[NewHiringController::class,'storememo'])->name('store.hiring');
// Route::post('/hiring/storememo',[NewHiringController::class,'storememo'])->name('store.hiring');
...
// Dodd
Route::get('/dodd-forms/ispdocumentation', [IspdocumentationController::class, 'index'])->name('dodd-forms.ispdocumentation');
Route::get('/dodd-forms/mileage-log', [nonskilledAgencyController::class, 'mileage'])->name('dodd-forms.mileage-log');
Route::get('/dodd-forms/activities-goals-log', [nonskilledAgencyController::class, 'activitiesgoal'])->name('dodd-forms.activities-goals-log');
Route::get('/dodd-forms/medication-administration-record', [nonskilledAgencyController::class, 'medadministtration'])->name('dodd-forms.medication-administration-record');
Route::get('/dodd-forms/medication-count-list', [nonskilledAgencyController::class, 'medlist'])->name('dodd-forms.medication-count-list');
Route::get('/dodd-forms/medication-as-needed', [nonskilledAgencyController::class, 'asneeded'])->name('dodd-forms.medication-as-needed');



// Home Care
Route::resources(['nonoasis-recertification' => NonOasisRecertificationController::class]);
Route::resources(['planofcare' => PlanOfCareController::class]);
Route::resources(['nonoasis-discharge' => NonOasisDischargeController::class]);
...
//Non-Skilled Agency
Route::get('/non-skilled-agency/hha-supervisory', [NonskilledAgencyController::class, 'index'])->name('non-skilled-agency.hha-supervisory');
...
Route::post('/patients/non-skilled-ispdocs', [NonskilledAgencyController::class, 'ispdocs'])->name('nonskilled.ispdocs');
Route::post('/patients/non-skilled-agency-Report', [NonskilledAgencyController::class, 'agencyReport'])->name('nonskilled.agencyreport');
Route::post('/patients/non-skilled-MUI-Report', [NonskilledAgencyController::class, 'MUIreport'])->name('nonskilled.MUIreport');
Route::post('/patients/non-skilled-MUI-hospitalization', [NonskilledAgencyController::class, 'MUIhospitalization'])->name('nonskilled.hospitalization');
Route::post('/patients/non-skilled-unapproved-behavioral', [NonskilledAgencyController::class, 'unapprovedBehavioral'])->name('nonskilled.unapprovedBehavioral');
Route::post('/patients/non-skilled-unusal-incident-report', [NonskilledAgencyController::class, 'unusalIncidentReport'])->name('nonskilled.unusalIncidentReport');
Route::post('/patients/non-skilled-hpc-time-Sheet', [NonskilledAgencyController::class, 'hpcTimeSheetStore'])->name('nonskilled.hpcTimeSheetStore');

Route::post('/patients/non-skilled-active-goal-store', [NonskilledAgencyController::class, 'activeGoalStore'])->name('nonskilled.activeGoalStore');
Route::post('/patients/non-skilled-nonskilled-medication-administration-store', [NonskilledAgencyController::class, 'medicationAdministrationStore'])->name('nonskilled.medicationAdministrationStore');
Route::post('/patients/non-skilled-nonskilled-medication-as-need-store', [NonskilledAgencyController::class, 'medicationAssNeedStore'])->name('nonskilled.medicationAssNeedStore');
Route::post('/patients/non-skilled-nonskilled-medication-count-sheet-store', [NonskilledAgencyController::class, 'medicationCountSheetStore'])->name('nonskilled.medicationCountSheetStore');
Route::post('/patients/non-skilled-nonskilled-milage-log', [NonskilledAgencyController::class, 'milageLogStore'])->name('nonskilled.milageLogStore');
...
Route::get('/infections/infection-control', [InfectionControllerController::class, 'index'])->name('infections.infection-control');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('cookie-consent-preferences', [CookiesController::class, 'index'])->name('CookiesController');
     ...
     // DODD Forms
     Route::get('/dodd-forms/annual-agency-report', [AnnualReportAgencyProviderController::class, 'index'])->name('dodd-forms.annual-agency-report');
     Route::get('/dodd-forms/hpc-timesheet', [HpcTimesheetController::class, 'index'])->name('dodd-forms.hpc-timesheet');
     Route::get('/dodd-forms/possible-mui-report', [ReportmuiController::class, 'index'])->name('dodd-forms.possible-mui-report');
     Route::get('/dodd-forms/unanticipatedhospitalization-mui-form', [UnanticipatedhospitalizationmuiController::class, 'index'])->name('dodd-forms.unanticipatedhospitalization-mui-form');
     Route::get('/dodd-forms/unusual-incident-report-log', [UnusualincidentReportlogController::class, 'index'])->name('dodd-forms.unusual-incident-report-log');
     Route::get('/dodd-forms/unapproved-behavioral-support-mui-form', [UnapprovedbehavioralsupportController::class, 'index'])->name('dodd-forms.unapproved-behavioral-support-mui-form');

     Route::post('dodd-forms/store', [AnnualReportAgencyProviderController::class, 'store'])->name('dodd-forms.store');
     // Route::post('dodd-forms/hpc-timesheet', [ReportmuiController::class, 'store'])->name('dodd-forms.store');
    //Route::post('dodd-forms/reportui', [ReportmuiController::class, 'store'])->name('dodd-forms.store');
     // Route::post('dodd-forms/store', [UnanticipatedhospitalizationmuiController::class, 'store'])->name('dodd-forms.store');
     // Route::post('dodd-forms/store', [UnapprovedbehavioralsupportController::class, 'store'])->name('dodd-forms.store');
     // Added by Enamul
    ...
    */
    ...
    Route::post('/medication/discontinue/store', [MedicationController::class, 'discontinueStore'])->name('medication.discontinue.store');
