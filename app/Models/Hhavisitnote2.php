...
class hhavisitnote2 extends Model
{
    // protected $fillable = [
    ...
    //     'comments_32', 'reposition','every_hrs', 'comments_33', 'exercise_pt', 'exercise_ot', 'exercise_slp', 'refused_17',
    ...
    // ];
    protected $table = 'hhavisitnote2s';
    protected $guarded = [];
}
